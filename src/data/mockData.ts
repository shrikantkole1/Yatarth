...
export const INITIAL_PRODUCTS: Product[] = [
    ...
    sides: [
      {
        ...
        imageUrl: '/images/products/almond_cookies.jpg',
        boundingBoxes: [
          {
            id: 'box-01',
    ...
    sides: [
      {
        id: 'side-lays-front',
        sideName: 'Front Panel',
        imageUrl: '/images/products/lays_chips.jpg',
        boundingBoxes: [
          {
            id: 'box-lays-01',
            field: 'Product Identity',
          ...
          {
            id: 'box-lays-03',
            field: 'Net Weight & Barcode',
            category: 'net_quantity',
            x: 24,
            y: 77,
            width: 70,
            height: 10,
            detectedText: 'NET WT 50g • BATCH: LAY-EXP-2025-09',
            confidence: 98.9,
            status: 'detected'
          }
        ]
  ...
  },
  {
    id: 'prod-02',
    sku: 'YAT-NDL-002',
    name: 'Desi Spice 2-Minute Masala Instant Noodles (70g Pouch)',
    category: 'Packaged Food & Snacks',
    brand: 'Desi Foods FMCG',
    packSize: '70 g',
    batchNumber: 'DN23F01',
    complianceScore: 78,
    status: 'warning',
    ...
    sides: [
      {
        id: 'side-02-front',
        sideName: 'Front Panel',
        imageUrl: '/images/products/masala_noodles.jpg',
        boundingBoxes: [
          {
            id: 'box-ndl-1',
            field: 'Product Identity',
            ...
            width: 50,
            height: 26,
            detectedText: 'Desi Spice Masala Noodles (Flavour)',
            confidence: 99.5,
            status: 'detected'
          },
          {
            id: 'box-ndl-2',
            field: 'Net Quantity & Price',
            category: 'net_quantity',
            x: 25,
            y: 70,
            width: 35,
            height: 10,
            detectedText: 'NET QUANTITY: 70g • Rs. 15.00 (Incl. of all taxes)',
            confidence: 98.4,
            status: 'detected'
          },
          {
            id: 'box-ndl-3',
            field: 'Batch & Expiry Dates',
            category: 'dates',
            x: 58,
            y: 70,
            width: 40,
            height: 10,
            detectedText: 'BATP: DN23F01 • MFG: 10/2023 • EXP: 10/2024',
            confidence: 97.2,
            status: 'detected'
          }
        ]
  ...
  },
  {
    id: 'prod-03',
    sku: 'YAT-NK-003',
    name: "Haldiram's Nagoori Aloo Bhujia (150g Pouch)",
    category: 'Packaged Food & Snacks',
    brand: 'Haldiram Snacks Pvt. Ltd.',
    packSize: '150 g',
    batchNumber: 'HLD-BHU-2026-N9',
    complianceScore: 78,
    status: 'warning',
    lastScanDate: '2026-09-08 11:20',
    issuesCount: 2,
    criticalIssues: 0,
    owner: 'Suresh Kumar (FEO)',
    sides: [
      {
        ...
        boundingBoxes: [
          {
            id: 'box-bhujia-1',
            field: 'Product Identity & Brand',
            category: 'origin',
            x: 18,
            y: 20,
            width: 64,
            height: 22,
            detectedText: "HALDIRAM'S NAGHOORI ALOO BHUJIA",
            confidence: 99.4,
            status: 'detected'
          },
          {
            id: 'box-bhujia-2',
            field: 'Net Quantity Font Sizing',
            category: 'net_quantity',
            x: 20,
            y: 65,
            width: 32,
            height: 10,
            detectedText: 'NET WT: 150g (Font height: 2.1mm - below 3.0mm requirement)',
            confidence: 97.2,
            status: 'needs_review',
            violationId: 'viol-05'
          },
          {
            ...
            width: 35,
            height: 10,
            detectedText: 'MRP ₹ 55.00 (INCL. OF ALL TAXES) • USP: ₹0.37 / g',
            confidence: 98.9,
            status: 'detected'
          },
          {
            id: 'box-bhujia-4',
            field: 'Consumer Redressal Contacts',
            category: 'consumer_care',
            x: 18,
            y: 78,
            width: 65,
            height: 10,
            detectedText: 'Care: feedback@haldirams.com • Ph: 0712-2681123',
            confidence: 98.5,
            status: 'detected'
          }
        ]
    ...
    declarations: [
      { id: 'dec-b1', key: 'net_qty', label: 'Net Quantity Declaration', detectedValue: '150 g (2.1mm height)', standardRequired: 'Minimum 3.0mm font height for packages 100g-500g under PCR 2011 Table I', status: 'needs_review', category: 'Metrology', confidence: 97.2, notes: 'Net quantity numeral printed below mandatory 3mm threshold.' },
      { id: 'dec-b2', key: 'mrp', label: 'Maximum Retail Price', detectedValue: '₹ 55.00 (INCL. OF ALL TAXES)', standardRequired: 'Explicit tax inclusive representation', status: 'detected', category: 'Pricing', confidence: 98.9 },
      { id: 'dec-b3', key: 'usp', label: 'Unit Sale Price (USP)', detectedValue: '₹ 0.37 per gram', standardRequired: 'Mandatory USP on retail packages under Rule 6(11)', status: 'detected', category: 'Pricing', confidence: 99.1 },
      { id: 'dec-b4', key: 'origin', label: 'Country of Origin', detectedValue: 'Made in India', standardRequired: 'Country of origin statement', status: 'detected', category: 'Trade Origin', confidence: 99.9 },
      { id: 'dec-b5', key: 'consumer_care', label: 'Consumer Redressal Cell', detectedValue: 'feedback@haldirams.com / 0712-2681123', standardRequired: 'Complete redressal contact', status: 'detected', category: 'Consumer Protection', confidence: 98.5 }
    ],
    violations: [
      {
        id: 'viol-05',
        productId: 'prod-03',
        productName: "Haldiram's Nagoori Aloo Bhujia (150g Pouch)",
        sku: 'YAT-NK-003',
        title: 'Net quantity numeral font height below mandatory 3.0 mm specification',
        category: 'Net Quantity',
        severity: 'medium',
        explanation: 'For pre-packaged food commodities between 100g and 500g net quantity, Rule 7 / Schedule II mandates a minimum font height of 3.0 mm. Detected visual numeral height is 2.1 mm.',
        evidence: 'Measured numeral height on 150g foil pouch: 2.1 mm vs 3.0 mm statutory threshold.',
        recommendedAction: 'Serve notice under Section 39 / Rule 7 for packaging label rectification.',
        reviewStatus: 'under_review',
        detectedAt: '2026-09-08 11:20',
        assignedTo: 'Suresh Kumar',
        ruleCode: 'RULE-NET-01'
      }
    ],
    history: [
      { date: '2026-09-08 11:20', score: 78, scannedBy: 'Yatarth AI Engine v4.2', notes: 'Warning flagged on font sizing verification module.' }
    ]
  },
  {
    id: 'prod-04',
