...
================================================================================`;
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 animate-in fade-in text-slate-900">
      ...
      <div className="rounded-2xl border-2 border-blue-400 bg-gradient-to-b from-blue-50/70 via-white to-slate-50 p-5 shadow-xs space-y-4">
      ...
      {trace ? (
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-300 shadow-xs space-y-6">
            ...
            {/* Tab: Reverse Store Mapping (Pipeline Stage 4) */}
            ...
            {/* Tab: Regional Area Impact (Pipeline Stage 5) */}
            ...
            {/* Tab: Smart Escalation Notice (Pipeline Stage 6) */}
